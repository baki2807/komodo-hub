...
export async function POST(request: Request) {
  try {
    // Bypass authentication for initialization
    // Get authorization from headers if available for production
    const authHeader = request.headers.get('Authorization')
    
    // In production you might want to check for a secret key
